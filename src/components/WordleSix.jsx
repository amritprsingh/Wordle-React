...
import { LETTERS, sixLetters } from "../data/words";

const potentialWords = sixLetters;
export default function WordleSix({ setMode, SOLUTION }) {
  ...
  const hitEnter = () => {
    if (activeRowIndex > 6) {
      ...
      setNotification("SIX LETTER WORDS ONLY");
    }
  };
